...
// keyToJanusgraph translates a thing struct into a vertex string
func (f *Janusgraph) keyToJanusgraph(objToHandle *models.Key, token string, UUID string, addOrUpdate string) (string, string) {
