...
func (f *Janusgraph) processSingleAction(result interface{}, actionNo int, actionResponse *models.ActionGetResponse) error {
...
func (f *Janusgraph) actionToJanusgraph(UUID strfmt.UUID, objToHandle *models.Action, addOrUpdate string) error {
